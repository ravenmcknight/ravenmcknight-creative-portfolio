...
For the purpose of clustering, Lee and Mitchell's model doesn't take any predictors. Instead, it locates boundaries between clusters of high disease risk or, in our case, limited birth control access. In the next section, we'll fit a model using this method via the `S.CARdissimilarity()` function in CARBayes. 
...
# figure out mathJax
# fit model
# can we map the boundaries over Tennessee to see how well we did?
# summarize clusters
# theorize why the clusters exist in TN
```
