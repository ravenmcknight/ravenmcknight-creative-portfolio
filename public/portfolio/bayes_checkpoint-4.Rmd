...
We'll start by implementing simple, non-spatial models. I think the most intuitive predictor is region, so we'll start my modeling `WomenPerClinic` by `Region`. 
