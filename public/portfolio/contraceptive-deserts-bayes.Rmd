...
![](/Users/raven/Documents/sites/ravenmcknight/static/img/portfolio/leemitchellstatement.png)
...
nc_dissimilarity <- S.CARdissimilarity(formula=formula, data=nc_sp_mod, family="gaussian", W=W, Z=list(Z.inc=Z.inc, Z.grad=Z.grad), W.binary=TRUE, burnin=100000, n.sample=300000, thin=20)
```
...
addLayersControl(
  overlayGroups = c("Basemap", "Variables", "Boundaries"),
